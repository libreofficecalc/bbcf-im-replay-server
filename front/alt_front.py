...
#        dcc.Input(id =  "p1-toon", type = 'number', placeholder= 'Enter toon'),
        html.Div(id = 'toon-select-div',
            children = dcc.Dropdown(id = 'p1-toon', options = dropdown_pre_computed_label_value,placeholder = "Select character")),

        # Text Input For P1
        dcc.Input(id='p1-input', type='text', placeholder='Enter player name'),
    
        # Text input for p1_steamid64
        dcc.Input(id='p1-steamid64-input', type='text', placeholder='Enter player steamid64'),
